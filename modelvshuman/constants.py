...
HARMONIZATION_BASELINE_MODELS = ["tf_convnext_tiny", "tf_efficientnet_b0", "tf_levit128", "tf_maxvit_tiny", "tf_resnet50_v2", "tf_vgg16", "tf_vit_b16"]

#models provided by Dapello, Marques et al. (2020) at https://github.com/dicarlolab/vonenet
...
BIT_M_MODELS = ["tfhub_bit_m-r50x1", "tfhub_bit_m-r50x3", "tfhub_bit_m-r101x1", "tfhub_bit_m-r101x3", "tfhub_bit_m-r152x4"]
BIT_S_MODELS = ["tfhub_bit_s-r50x1", "tfhub_bit_s-r50x3", "tfhub_bit_s-r101x1", "tfhub_bit_s-r101x3", "tfhub_bit_s-r152x4"]